...
class PerformanceTest {
    private static final int EXPECTED = 200_001;
    private static final int MAX_SIZE_IN_BYTES = 100_060_000;
    ...
    void testLRU() {
        ...
        System.out
                .println("LRU put execution time for " + MAX_ITEMS + " items: " + (endTime - startTime) / 1_000_000
                        + " ms");
        ...
        System.out
                .println("LRU get execution time for " + MAX_ITEMS + " items: " + (endTime - startTime) / 1_000_000
                        + " ms");
        System.out.println("\nLRU cache metrics:");
    ...
    void testLFU() {
        ...
        long endTime = System.nanoTime();
        System.out
                .println("LFU put execution time for " + MAX_ITEMS + " items: " + (endTime - startTime) / 1_000_000
                        + " ms");
        ...
        endTime = System.nanoTime();
        System.out
                .println("LFU get execution time for " + MAX_ITEMS + " items: " + (endTime - startTime) / 1_000_000
                        + " ms");
        System.out.println("\nLFU cache metrics:");
